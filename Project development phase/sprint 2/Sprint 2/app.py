...
COS_API_KEY_ID="94MSDYsBfWs4oY15b-GJdP3BaOCendaEFJp68inckSfw"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/dc84cfb35e7d4ccf9d26686ea199814f:1002eba3-5f44-42b5-b318-2bbfa4c9e7e2::"
...
def delete_item(bucket_name, object_name):
    try:
        cos.delete_Object(bucket_name, object_name).delete()
...
@app.route('/')
def index():
    files = get_bucket_contents('flask3006')
