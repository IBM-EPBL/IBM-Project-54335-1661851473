...
## csv code
import pandas as pd
read_file = pd.read_excel ("C:\\Users\\nivi\\Desktop\\IBM2\\Book.xlsx")
...
def tasks():
    ...
    if request.method == 'POST':
        if request.form.get('click') == 'Capture':
            ...
            # prediction = model.predict([image("C:\\Users\\nivi\\Desktop\\IBM2\\download.jfif")])
